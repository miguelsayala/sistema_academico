...
// Como enviamos nuestro id aca lo recibimos con un metodo GET para 
$id_semestre = $_GET['id'];
// Buscamos el semestre por su ID para editarlo
$buscar_semestre = buscarSemestreById($conexion, $id_semestre);
// Almacenamos el resultado de nuestra consulta
$res_busca_semestre = mysqli_fetch_array($buscar_semestre);
        ...
        <div class="row">
              <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  ...
                  <div class="x_content">
                    <br />
                    <!-- No olvidar que el action indica que en esa ruta se va a ejecutar esta accion -->
                    <form class="form-horizontal form-label-left" method="POST" action="./operaciones/actualizar_semestre.php">
                    <input type="hidden" name="id" value="<?php echo 
                    // Mostramos el ID que obtenemos desde nuestra tabla
                    $id_semestre;?>">
                      <div class="form-group">
                        <label class="control-label col-md-3 col-sm-3 col-xs-12" for="first-name">Codigo :
                        </label>
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input type="text" name="descripcion" class="form-control col-md-7 col-xs-12" value="<?php 
                          // una vez hecho la busqueda lo moestramos en este input
                          echo $res_busca_semestre['descripcion']; ?>">
                        </div>
                        </div>          
                      <div class="ln_solid"></div>
                      <div class="form-group">
                        <div class="col-md-6 col-sm-6 col-xs-12 col-md-offset-3">
                          <a href="./semestre.php" class="btn btn-warning" type="button">Cancelar</a>
