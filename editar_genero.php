...
// Obtenemos el id que mandamos de nuestra tabla en genero.php
$id_genero = $_GET['id'];
// Buscamos el genero para mostrarlo
$buscar_genero = buscarGeneroById($conexion, $id_genero);
// almacenamos el resultado en una variable
$res_busqueda_genero= mysqli_fetch_array($buscar_genero);
                                ...
                                <form class="form-horizontal form-label-left" method="POST" action="./operaciones/actualizar_genero.php">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-6 col-sm-6 col-xs-12">
                                            <input type="text" name="genero" class="form-control col-md-7 col-xs-12" value="<?php echo $res_busqueda_genero['genero']; ?>">
                                        </div>
                                    </div>
