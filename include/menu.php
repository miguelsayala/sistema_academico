        ...
        <div class="col-md-3 left_col">
          <div class="left_col scroll-view">
            ...
            <?php
            // Verificamos que un docente hay iniciado sesion
            $busc_usu_docente_ses = buscarUsuarioDocenteById($conexion, $_SESSION['id_usu_sisacad_iesthuanta']);
            $res_bus_usu_ses = mysqli_fetch_array($busc_usu_docente_ses);
            // Obtenemos el id del docente para inicio de sesion
            $id_d_b_S = $res_bus_usu_ses['id_docente'];
            // Buscamos que docente a iniciado sesion
            ...
            <div class="profile clearfix">
              ...
              <div class="profile_info">
                ...
                <h2>
                  <?php
                  // Imprimimos el nombre y apellido del docente
                  echo $res_b_d_s['apellidos_nombres']; 
                  ?></h2>
              </div>
            </div>
            <!-- /menu profile quick info -->
              ...
              <ul class="nav navbar-nav navbar-right">
                <li class="">
                  <a href="javascript:;" class="user-profile dropdown-toggle" data-toggle="dropdown" aria-expanded="false">
                    <img src="Gentella/production/images/img.jpg" alt=""><?php 
                    // Imprimimos el nombre y apellido del docente
                    echo $res_b_d_s['apellidos_nombres']; 
                    ?>
