                ...
                <div class="row">
                    <div class="col-md-12 col-sm-12 col-xs-12">
                        <div class="x_panel">
                            ...
                            <div class="x_content">
                                <br />
                                <form class="form-horizontal form-label-left" method="POST" action="operaciones/resgitrar_modulos.php">

                                    <div class="form-group">
                                        <label class="control-label col-md-3 col-sm-3 col-xs-12" for="first-name">Carrera Profesional :
                                        </label>
                                        <div class="col-md-6 col-sm-6 col-xs-12">
                                            <select type="text" name="programa_estudios" class="form-control col-md-7 col-xs-12">
                                            <option value="">Seleccionar Programa</option>
                                            <?php 
                                            // para ya mostrar en un select buscamos el programa de estudios
                                            $b_programa = buscarProgramaEstudio($conexion);
                                            // recorremos con un while
                                            while ($res_buscar_prog = mysqli_fetch_array($b_programa)) {
                                            ?> 
                                            <option value="<?php 
                                            // imprimimos el id y el nombre
                                            echo $res_buscar_prog['id']?>"> <?php echo $res_buscar_prog['nombre']?> </option>
                                            <?php
                                            }
                                            ?>
                                            </select>
