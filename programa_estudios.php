                        ...
                        <div class="x_panel">
                            <div class="x_title">
                                ...
                                <ul class="nav navbar-right">
                                    <li>
                                        <a href="resgitrar_programa.php" class="btn btn-success">Agregar nuevo</a>
                                    </li>
                                </ul>
                            ...
                            <div class="x_content">
                                ...
                                <table id="example" class="table table-striped table-bordered">
                                    ...
                                    <tbody>
                                        ...
                                        // buscamo el porgrama de estudios para mostralo en nuestra tabla
                                        $buscar_programa = buscarProgramaEstudio($conexion);
                                        // con un while recorremos todos los datos que tiene este
