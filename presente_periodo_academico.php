						...
						<div class="x_panel">
							...
							<div class="x_content">
								...
								<table id="example" class="table table-striped table-bordered">
									...
									<tbody>
										<?php
										// Buscarmos el presente periodo academico
										$busc_presente_periodo = buscar_pre_per_academico($conexion);
										// con un while extraemos los datos de nuestra tabla presente periodo academico
										...
										?>
											<tr>
												...
												$res_bus_per_aca_id = mysqli_fetch_array($bus_periodo);
												?>
												<td ><?php
												// con la busqueda por el id extraemos el nombre del periodo academico
												echo $res_bus_per_aca_id['nombre']; ?></td>
