...
$id_cargo = $_GET['id'];
// Buscamos el cargo por id para acceder a sus valores
$buscar_cargo = buscarCargoById($conexion, $id_cargo);
// Accedemos a los valores
$res_busqueda_cargo = mysqli_fetch_array($buscar_cargo);
?>
<!DOCTYPE html>
<html lang="en">
                                                ...
                                                <div class="x_content">
                                                    ...
                                                    <input type="hidden" name="id" value="<?php echo $id_cargo;?>">
                                                        ...
                                                        <div class="item form-group">
                                                            ...
                                                            <input type="text" name="cargo" class="date-picker form-control col-md-7 col-xs-12" value="<?php echo $res_busqueda_cargo['descripcion']; ?>">
                                                            </div>
                                                        </div>
                                                        <br><br>
