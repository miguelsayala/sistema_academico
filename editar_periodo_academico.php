...
// Obtenemos el id de la fila para mostrarlo en nuestros imputs 
$id_periodo_academico = $_GET['id'];
$busc_per_academico = buscarPeriodoAcademicoById($conexion, $id_periodo_academico);
$res_bus_per_academico = mysqli_fetch_array($busc_per_academico);
// Como el director es una llabe foranea obtendremos el id para acceder luego a sus otros datos
$id_director = $res_bus_per_academico['id_director'];
                ...
                <form class="form-horizontal form-label-left" method="POST" action="operaciones/actualizar_periodo_academico.php">
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-md-6 col-sm-6 col-xs-12">
                      <input type="text" name="nombre" required="required" class="form-control col-md-7 col-xs-12" value="<?php echo $res_bus_per_academico['nombre']; ?>">
                    </div>
                  </div>
                  <div class="form-group">
                    ...
                    <div class="col-md-6 col-sm-6 col-xs-12">
                      <input type="date" name="fecha_inicio" required="required" class="form-control col-md-7 col-xs-12" value="<?php echo $res_bus_per_academico['fecha_inicio']; ?>">
                    </div>
                  </div>
                  <div class="form-group">
                    ...
                    <div class="col-md-6 col-sm-6 col-xs-12">
                      <input type="date" name="fecha_fin" required="required" class="form-control col-md-7 col-xs-12" value="<?php echo $res_bus_per_academico['fecha_fin']; ?>">
                    </div>
                  </div>
                  <div class="item form-group">
                    ...
                    <div class="col-md-6 col-sm-6 col-xs-12">
                      <select type="text" id="director" name="director" class="form-control col-md-7 col-xs-12" value='<?php echo $id_director; ?>'>
                        ...
                        <?php
                        // como docente es una llave foranea lo tengo que buscar por su id a sus otros datos
                        $buscar_docente = buscarDocente($conexion);
                        while ($res_buscar_docente = mysqli_fetch_array($buscar_docente)) {
                          $id_busc_director = $res_buscar_docente['id'];
                        ?>
                        <option value="<?php echo $id_busc_director; ?>" 
                          <?php if($id_director === $id_busc_director){
                            echo "selected";
                          } ?>
                          ><?php echo $res_buscar_docente['apellidos_nombres']; ?></option>
                          <?php
                          };
                          ?>
                      </select>
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-md-6 col-sm-6 col-xs-12">
                      <input type="date" name="fecha_actas" required="required" class="form-control col-md-7 col-xs-12" value="<?php echo $res_bus_per_academico['fecha_actas']; ?>">
                    </div>
                  </div>
