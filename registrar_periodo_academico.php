								...
								<div class="x_title">
									...
									<div class="row">
										<div class="col-md-12 col-sm-12 col-xs-12">
											<div class="x_panel">
												<div class="x_title">
													<h2>Registrar Periodo Academico<small></small></h2>
													<div class="clearfix"></div>
												</div>
												<div class="x_content">
													<form class="form-horizontal form-label-left" action="./operaciones/registrar_periodo_academico.php" method="POST" id="formulario_docente">
														<div class="item form-group">
															<label class="control-label col-md-3 col-sm-3 col-xs-12" for="name">Periodo Académico
																<span class="required">:</span>
															</label>
															<div class="col-md-6 col-sm-6 col-xs-12">
																<input id="periodo_academico" class="form-control col-md-7 col-xs-12" name="periodo_academico" placeholder="Ingrese el periodo académico">
															</div>
														</div>
														<div class="item form-group">
															<label class="control-label col-md-3 col-sm-3 col-xs-12" for="email">Fecha de Inicio<span class="required">:</span>
															</label>
															<div class="col-md-6 col-sm-6 col-xs-12">
																<input type="date" id="fecha_inicio" name="fecha_inicio" class="form-control col-md-7 col-xs-12">
															</div>
														</div>
														<div class="item form-group">
															<label class="control-label col-md-3 col-sm-3 col-xs-12" for="email">Fecha de Fin<span class="required">:</span>
															</label>
															<div class="col-md-6 col-sm-6 col-xs-12">
																<input type="date" id="fecha_fin" name="fecha_fin" class="form-control col-md-7 col-xs-12">
															</div>
														</div>
														<div class="item form-group">
														...
														<div class="item form-group">
															<label class="control-label col-md-3 col-sm-3 col-xs-12" for="website">Fecha para Actas<span class="required">:</span>
															</label>
															<div class="col-md-6 col-sm-6 col-xs-12">
																<input type="date" id="fecha_actas" name="fecha_actas" class="form-control col-md-7 col-xs-12">
															</div>
														</div>
														<br><br>
